*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHR_TITULOTRAB_V
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHR_TITULOTRAB_V    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHR_TITULOTRAB_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHR_TITULOTRAB_V_EXTRACT
TOTAL = ZHR_TITULOTRAB_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHR_TITULOTRAB_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHR_TITULOTRAB_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHR_TITULOTRAB_V_EXTRACT
TOTAL = ZHR_TITULOTRAB_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHR_TITULOTRAB_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHR_TITULOTRAB_V'
...
TOTAL = ZHR_TITULOTRAB_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHR_TITULOTRAB_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHR_TITULOTRAB_V-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZHR_TITULOTRAB_V'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZHR_TITULOTRAB_V-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHR_TITULOTRAB_V_EXTRACT
TOTAL = ZHR_TITULOTRAB_V_TOTAL
